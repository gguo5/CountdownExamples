...
jQuery.fn.extend({
    jCountdown:function(){
        ...
        var Slide = function(target){
            ...
            this.frame = function(v){
                if(v==undefined){
                    ...
                    if(countUpFlag){
                        var top = -((this.value()-1)*this.height()) - (Math.sin((this.frame()-1)/(this.totalFrames()-1)*Math.PI/2)*this.height());
                    }else{
            ...
            this.checkTime = function(update){
                ...
                if(countUpFlag){
                    if(this._time.getTime()>(currentTime.getTime()+currentTime.getTimezoneOffset()*60*1000)){
                        ...
                        var currentTimeText = this.timeFormat((currentTime.getTime()+currentTime.getTimezoneOffset()*60*1000)-this._time.getTime(), this._days.length, this._hours.length, this._minutes.length, this._seconds.length);
        ...
        var init = function(setting){
            ...
            //count up flag
            countUpFlag = setting.countUpFlag!=false;
